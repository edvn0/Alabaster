...
function(register_for_project PROJECT HAS_TESTS)
  if(CLANG_FORMAT
     AND NOT ALABASTER_CI
     AND ALABASTER_FORMAT)
  ...
  if(CLANG_FORMAT
     AND ALABASTER_IS_BUILD_TOOL STREQUAL "OFF"
     AND ALABASTER_SHOULD_FORMAT STREQUAL "ON")
...
function(add_os_specific_objects sources all_sources)
  ...
  file(GLOB_RECURSE compiler_sources
       "src/platform/${ALABASTER_COMPILER}/**.cpp")
